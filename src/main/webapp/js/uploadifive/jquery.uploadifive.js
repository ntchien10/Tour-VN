        ...
        init : function(options) {
            ...
            return this.each(function() {
                ...
                var settings = $data.settings = $.extend({
                    ...
                    'buttonText'      : 'Đính kèm',     	// The text that appears on the UploadiFive button
                    ...
                    'uploadScript'    : 'upload/fancy',  // The path to the upload script
                ...
                $data.uploadComplete = function(e, file, uploadAll) {
                    ...
                    if ($.inArray('onUploadComplete', settings.overrideEvents) < 0) {
                    	var v_sysFileId = file.xhr.responseText;
                    	var v_fileName = file.queueItem.find('.filename').html();
                    	var url_fileName = getUrlFileName(v_sysFileId,v_fileName);
                    	file.queueItem.find('.filename').html(url_fileName);
